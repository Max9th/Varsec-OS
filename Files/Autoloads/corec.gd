...
func change_wallpaper(texture: StringName):
	emit_signal("change_wallpaper_signal", texture)
	print("CorecCHANGEWALLPAPER")

func change_vfx_shader(shader: StringName):
